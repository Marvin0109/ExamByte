...
public class SubmitTest {
    ...
    void test_01() throws Exception {
        ...
        when(examManagementService.submitExam(eq("Marvin0109"), anyMap(), eq(examFachId))).thenReturn(false);

        mvc.perform(post("/exams/submit/{examFachId}", examFachId)
                .with(csrf())
                .param("antworten[" + frageId1 + "]", "Antwort 1") // SC
                .param("antworten[" + frageId2 + "]", "Antwort 1", "Antwort 2") // MC
                .param("antworten[" + frageId3 + "]", "Dies ist meine Freitext Antwort"))
    ...
    void test_02() throws Exception {
        ...
        when(examManagementService.submitExam(eq("Marvin0109"), anyMap(), eq(examFachId)))
                .thenReturn(true);
